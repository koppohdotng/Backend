 ...
 */
const getWebToken = (partner_id, api_key, url, requestParams, defaultCallback) => {
    if (!requestParams) {
    ...
    return axios_1.default
        .post(`https://${(0, helpers_1.mapServerUri)(url)}/token`, body)
        .then((response) => response.data);
};
exports.getWebToken = getWebToken;
//# sourceMappingURL=web-token.js.map