...
class Span  {
   ...
   */
   constructor(spanContext = {}) {
    ...
    this.setAttribute(semanticAttributes.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, spanContext.origin || 'manual');
    ...
    if (spanContext.op) {
      this.setAttribute(semanticAttributes.SEMANTIC_ATTRIBUTE_SENTRY_OP, spanContext.op);
    }
